        ...
        break
          ...
          try: 
              for box in final_boxes:
                ...
                image = image / 255.
                image = image.flatten()
                now = datetime.now().strftime("%H%M%S")                 # HỆ ĐH WINDOWN THÌ THÊM datetime.datetime.now().strftime("%H%M%S")
                cv2.imwrite(f'media/{now}.jpg',crop)                    #ĐƯỜNG DẪN SAVE FILE SAU KHI CROP VÀO FOLDER PROJECT CỦA MỖI NGƯỜI
